...
//note images//
c4Image = loadImage('images/c4.png');
d4Image = loadImage('images/d4.png');
e4Image = loadImage('images/e4.png');
f4Image = loadImage('images/f4.png');
g4Image = loadImage('images/g4.png');
a4Image = loadImage('images/a4.png');
b4Image = loadImage('images/b4.png');
c5Image = loadImage('images/c5.png');
...
//image test//
e4Note = new Sprite(860, 300, 70, 70, 'k');
e4Note.image = (e4Image);
e4Note.visible = true;
e4Image.resize(400,400);

d4Note = new Sprite(860, 300, 70, 70, 'k');
d4Note.image = (d4Image);
d4Image.resize(400,400);
d4Note.visible = false;
//white note sprites//
...
if (key === 'e') {
     if (e4Note.visible = true) {
        score = score + 1; 
            e4Note.visible = false;
              d4Note.visible = true;
    } else {
        score = score - 1; 
    }

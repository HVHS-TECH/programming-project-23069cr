...
function setup() {
    ...
    crotchet1 = new Sprite(950, 365, 70, 70, 'k');
    crotchet1.image = (crotchetImg);
    crotchet1.visible = true;
    crotchetImg.resize(150, 300);

    crotchet2 = new Sprite(950, 305, 70, 70, 'k');
    crotchet2.image = (crotchetImg);
    crotchet2.visible = true;
    crotchetImg.resize(150, 300);

    crotchet3 = new Sprite(950, 245, 70, 70, 'k');
    crotchet3.image = (crotchetImg);
    crotchet3.visible = true;
    crotchetImg.resize(150, 300);
...
function keyPressed() {
    ...
    if (key === 'q' || key === 'e' || key === 't') {
        if (crotchet1.y == 365 || crotchet2.y == 305 || crotchet3.y == 245) {
            score = score + 1;
        } else {
            score = score - 1;
        }
